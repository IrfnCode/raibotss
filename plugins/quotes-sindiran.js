...
const handler = async (m, { conn, command, text }) => {
  ...
  await conn.reply(m.chat, `*_${m.sender.split(`@`)[0]}..._*`, null, { contextInfo: { mentionedJid: [m.sender] } });
  await conn.sendMessage(m.chat, { text: cina }, 'extendedTextMessage', { quoted: m });
};
