...
handler.all = async function (m) {
	...
	try {
		...
		global.kontak2 = [
		 ...
		 [owner[0], await conn.getName(owner[0] + '6289512149646@s.whatsapp.net'), 'Victoria Rosalind', 'https://clayzaaubert.my.id', true] // Kalo mau di tambah tinggal copy 1baris ini di tempel di bawahnya trs di edit dikit!
        ]
